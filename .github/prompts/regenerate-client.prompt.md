...
Regenerate the Python client code from the StatusPro OpenAPI specification.

## Pre-requisites

- OpenAPI spec is valid and up-to-date at `docs/statuspro-openapi.yaml`
...
1. **Commit changes**:
   ...
   ```bash
   git add statuspro_public_api_client/api/
   git add statuspro_public_api_client/models/
   git add statuspro_public_api_client/client.py
   git add statuspro_public_api_client/client_types.py
...
- `statuspro_public_api_client/api/**/*.py` - API endpoint methods
- `statuspro_public_api_client/models/**/*.py` - Data models (attrs)
- `statuspro_public_api_client/client.py` - Base client classes
- `statuspro_public_api_client/client_types.py` - Type definitions
- `statuspro_public_api_client/errors.py` - Error classes
...
- Check `docs/statuspro-openapi.yaml` for syntax errors
