...
- **Import types correctly**: `from statuspro_public_api_client.client_types import ...`
...
1. **Never edit generated files** - They're in `statuspro_public_api_client/api/` and
