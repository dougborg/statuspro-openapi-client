...
description: 'Python development specialist for implementing features and fixing bugs in the statuspro-openapi-client project'
...
You are a specialized Python development agent for the statuspro-openapi-client project.
...
layer in `StatusProClient`, **not** in individual API methods. This means:

- All API calls automatically get retry logic
- Rate limiting is handled transparently
- Pagination is automatic when using StatusProClient

**Read for details**: `docs/adr/0001-transport-layer-resilience.md`

### Pydantic Domain Models (ADR-011)

Use Pydantic domain models from `statuspro_public_api_client/domain/` for business logic,
...
When working on `statuspro_mcp_server`:

- **ServerContext Pattern**: Use `get_services()` to access StatusProClient
...
**Read for details**: `docs/adr/0010-statuspro-mcp-server.md`
...
- ❌ `from statuspro_public_api_client.types import ...` (wrong)
...
- `statuspro_public_api_client/api/**/*.py` - Generated API endpoints
- `statuspro_public_api_client/models/**/*.py` - Generated attrs models
- `statuspro_public_api_client/client.py` - Generated client base
- `statuspro_public_api_client/client_types.py` - Generated types
- `statuspro_public_api_client/errors.py` - Generated errors
...
- `statuspro_public_api_client/statuspro_client.py` - Enhanced client
- `statuspro_public_api_client/domain/**/*.py` - Pydantic domain models
- `statuspro_public_api_client/helpers/**/*.py` - Helper utilities
- `statuspro_mcp_server/src/**/*.py` - MCP server code
- `tests/**/*.py` - Test files
...
```python
from statuspro_mcp.server import ServerContext, get_services
...
async def get_products_by_category(
    ...
    Automatically handles pagination via StatusProClient.

    Args:
        client: Authenticated StatusProClient instance
...
- `docs/adr/0010-statuspro-mcp-server.md` - MCP server architecture
