...
- `feat(client):` → Releases statuspro-openapi-client (MINOR)
- `fix(client):` → Releases statuspro-openapi-client (PATCH)
- `feat(mcp):` → Releases statuspro-mcp-server (MINOR)
- `fix(mcp):` → Releases statuspro-mcp-server (PATCH)
- `feat(client)!:` → Releases statuspro-openapi-client (MAJOR)
...
### Client Package (`statuspro-openapi-client`)
...
### MCP Server Package (`statuspro-mcp-server`)
