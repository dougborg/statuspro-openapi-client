...
```python
# statuspro_mcp_server/src/statuspro_mcp/tools/manufacturing_orders.py
...
async def create_manufacturing_order(
    ...
    # Actual creation
    async with ctx.statuspro_client as client:
...
1. Verify MO appears in StatusPro UI
...
```python
# statuspro_mcp_server/src/statuspro_mcp/validation.py
...
def validate_product_exists(
    ...
    """Validate product exists in StatusPro."""
    # Check product exists
    ...

# Usage in tools
from statuspro_mcp.validation import validate_positive_quantity
...
- **Module location**: `src/statuspro_mcp/validation.py`
...
### Scope Labels
- `scope:client` - statuspro-openapi-client package
- `scope:mcp` - statuspro-mcp-server package
