...
1. **statuspro-openapi-client** - Python client library
1. **statuspro-mcp-server** - Model Context Protocol server
...
Triggers release of `statuspro-openapi-client`:
...
Triggers release of `statuspro-mcp-server`:
