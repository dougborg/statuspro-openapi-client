...
You create actionable implementation plans for the statuspro-openapi-client project.
...
- **statuspro-openapi-client** - Python SDK for StatusPro Manufacturing API
- **statuspro-mcp-server** - Model Context Protocol server for Claude
...
1. Study existing `statuspro_mcp_server/tools/purchase_orders.py` as pattern
