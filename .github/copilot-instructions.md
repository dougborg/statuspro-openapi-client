# AI Agent Instructions for StatusPro OpenAPI Client
...
cp .env.example .env
# Edit .env and add your STATUSPRO_API_KEY
...
uv run poe test-integration    # Integration tests (needs STATUSPRO_API_KEY)
...
- **`statuspro_public_api_client/statuspro_client.py`** - Main client with
  `ResilientAsyncTransport`
- **`statuspro_public_api_client/api/`** - 100+ generated API endpoint modules (DO NOT
  EDIT)
- **`statuspro_public_api_client/models/`** - 370+ generated data models (DO NOT EDIT)
- **`statuspro_public_api_client/domain/`** - Pydantic domain models (EDIT THESE)
- **`statuspro_public_api_client/helpers/`** - Helper classes for common operations
- **`statuspro_mcp_server/`** - MCP server implementation (separate package)
...
This means ALL API calls through `StatusProClient` automatically get retries, rate
...
- `statuspro_public_api_client/domain/**/*.py`
- `statuspro_public_api_client/helpers/**/*.py`
- `tests/`
- `scripts/`
- `docs/`
