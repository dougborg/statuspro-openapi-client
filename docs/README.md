...
├── client/                         # Symlink → statuspro_public_api_client/docs
├── mcp-server/                     # Symlink → statuspro_mcp_server/docs
├── adr/                            # Shared/monorepo ADRs
│   └── 0009-migrate-from-poetry-to-uv.md
└── reference/                      # Auto-generated API docs (built at runtime)

statuspro_public_api_client/docs/       # Python client documentation
...
statuspro_mcp_server/docs/              # MCP server documentation
...
packages/statuspro-client/docs/         # TypeScript client documentation
...
1. Triggered on push to `main` when `docs/**`, `mkdocs.yml`, or the client package
   change
