...
- **[Client ADRs](../../statuspro_public_api_client/docs/adr/README.md)** -
  `statuspro-openapi-client` package decisions
- **[MCP Server ADRs](../../statuspro_mcp_server/docs/adr/README.md)** -
  `statuspro-mcp-server` package decisions
