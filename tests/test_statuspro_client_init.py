"""Comprehensive tests for StatusProClient initialization and configuration.

This module tests all initialization paths, environment variable handling,
configuration validation, and parameter passing for the StatusProClient class.
"""
...
@pytest.mark.unit
class TestStatusProClientInitialization:
    """Test StatusProClient initialization with various parameter combinations."""
    ...
    def test_initialization_with_token_param_backwards_compat(self):
        ...
        client = StatusProClient(token="token-key", base_url="https://api.example.com")
        assert client._base_url == "https://api.example.com"
    ...
    def test_initialization_from_env_var(self):
        """Test initialization using STATUSPRO_API_KEY environment variable."""
        with patch.dict(os.environ, {"STATUSPRO_API_KEY": "env-api-key"}):
            client = StatusProClient(base_url="https://api.example.com")
            assert client._base_url == "https://api.example.com"

    def test_initialization_from_env_var_base_url(self):
        """Test initialization using STATUSPRO_BASE_URL environment variable."""
        with patch.dict(
            os.environ,
            {
                "STATUSPRO_API_KEY": "test-key",
                "STATUSPRO_BASE_URL": "https://env.api.com",
            },
        ):
            client = StatusProClient()
    ...
    def test_initialization_defaults_to_production_url(self):
        ...
        with patch.dict(os.environ, {"STATUSPRO_API_KEY": "test-key"}, clear=True):
            client = StatusProClient()
            assert client._base_url == "https://app.orderstatuspro.com/api/v1"
    ...
    def test_initialization_fails_without_api_key(self):
        ...
        with (
            patch("statuspro_public_api_client.statuspro_client.load_dotenv"),
            patch.dict(os.environ, {}, clear=True),
            pytest.raises(ValueError, match="API key required"),
        ):
            StatusProClient(base_url="https://api.example.com")
    ...
    def test_initialization_with_custom_logger(self):
        ...
        custom_logger = logging.getLogger("test_statuspro_client")
        client = StatusProClient(
            api_key="test-key",
    ...
    async def test_duck_type_logger_receives_log_calls(self):
        ...
        from statuspro_public_api_client.statuspro_client import ErrorLoggingTransport
    ...
    def test_initialization_from_netrc(self, tmp_path):
        ...
        with (
            ...
            patch.dict(os.environ, {}, clear=True),
            patch(
                "statuspro_public_api_client.statuspro_client.Path.home",
                return_value=tmp_path,
            ),
        ):
            client = StatusProClient(base_url="https://app.orderstatuspro.com/api/v1")
    ...
    def test_initialization_from_netrc_with_custom_base_url(self, tmp_path):
        ...
        with (
            ...
            client = StatusProClient(base_url="https://custom.api.com/v1")
    ...
    def test_initialization_env_var_overrides_netrc(self, tmp_path):
        ...
        with (
            patch.dict(os.environ, {"STATUSPRO_API_KEY": "env-key"}),
            patch(
                "statuspro_public_api_client.statuspro_client.Path.home",
                return_value=tmp_path,
            ),
    ...
    def test_initialization_explicit_overrides_netrc(self, tmp_path):
        ...
        with (
            ...
            client = StatusProClient(
                api_key="explicit-key", base_url="https://app.orderstatuspro.com/api/v1"
            )
            assert client._base_url == "https://app.orderstatuspro.com/api/v1"
    ...
    def test_initialization_netrc_missing_host_entry(self, tmp_path):
        ...
        with (
            ...
            StatusProClient(base_url="https://app.orderstatuspro.com/api/v1")
...
@pytest.mark.unit
class TestStatusProClientHttpxParameterPassing:
...
@pytest.mark.unit
class TestStatusProClientCustomTransport:
    """Test StatusProClient with custom transport configuration."""
    ...
    def test_default_resilient_transport_when_no_custom_provided(self):
        ...
        client = StatusProClient(api_key="test-key", base_url="https://api.example.com")
        transport = client._httpx_args["transport"]
...
@pytest.mark.unit
class TestStatusProClientEventHooks:
...
@pytest.mark.unit
class TestStatusProClientContextManager:
    """Test StatusProClient context manager behavior."""
...
@pytest.mark.unit
class TestStatusProClientObservabilityHooks:
