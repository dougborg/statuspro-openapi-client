...
Usage:
    ...
    uv run pytest --cov=statuspro_public_api_client --cov-report=json -m 'not docs' -q
    uv run python scripts/analyze_coverage.py
"""
...
def categorize_file(file_path: str) -> str:
    ...
    """
    if "statuspro_public_api_client/api/" in file_path:
        return "generated_api"
    elif "statuspro_public_api_client/models/" in file_path:
        return "generated_models"
    elif file_path in [
        "statuspro_public_api_client/statuspro_client.py",
        "statuspro_public_api_client/utils.py",
        "statuspro_public_api_client/client.py",
        "statuspro_public_api_client/log_setup.py",
        "statuspro_public_api_client/__init__.py",
    ]:
        return "core_logic"
    elif "statuspro_public_api_client/client_types.py" in file_path:
        return "generated_types"
    elif "statuspro_public_api_client/errors.py" in file_path:
...
def analyze_coverage() -> dict[str, CategoryStats]:
    ...
    if not coverage_data:
        ...
        print(
            "   uv run pytest --cov=statuspro_public_api_client"
...
def print_summary(categories: dict[str, CategoryStats]) -> None:
    ...
    print("   • Aim for 70%+ coverage on statuspro_client.py and utils.py")
