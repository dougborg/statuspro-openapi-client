...
def main():
    ...
    print("🔍 StatusPro OpenAPI Schema Consistency Validation")
    print(f"📅 Run at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("=" * 60)

    # Load specifications
    our_spec_path = Path("docs/statuspro-openapi.yaml")
    downloaded_spec_path = Path("docs/statuspro-api-comprehensive/openapi-spec.json")
