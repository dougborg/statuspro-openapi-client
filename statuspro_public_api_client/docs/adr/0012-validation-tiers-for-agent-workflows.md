...
- [Issue #93: infra: Create quick-check and agent-check poe tasks](https://github.com/dougborg/statuspro-openapi-client/issues/93)
- [PR #107: docs: update copilot-instructions.md and CLAUDE.md with uv and validation tiers](https://github.com/dougborg/statuspro-openapi-client/pull/107)
