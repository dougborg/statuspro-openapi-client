...
[ADR-010](0010-statuspro-mcp-server.md)). By implementing helpers first, MCP tools become
...
1. **Add helper properties to StatusProClient**
...
- Add helper properties to StatusProClient
- Write tests
