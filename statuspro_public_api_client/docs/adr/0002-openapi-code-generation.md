...
1. Maintain OpenAPI spec in `docs/statuspro-openapi.yaml`
...
└── statuspro_client.py  # Enhanced client (hand-written)
```

Clear separation:

- **Generated code** (`api/`, `models/`, `client.py`, etc.): Never edit manually
- **Custom code** (`statuspro_client.py`, `utils.py`): Hand-written enhancements
...
- `statuspro_client.py`: Enhanced client with resilience
...
- [StatusPro API Documentation](https://help.orderstatuspro.com/api)
- [scripts/regenerate_client.py](../../scripts/regenerate_client.py)
- [docs/statuspro-openapi.yaml](../statuspro-openapi.yaml)
