...
StatusPro OpenAPI Client and MCP Server project.
...
1. **Configure Environment**:
   ...
   # Add your StatusPro API key
   STATUSPRO_API_KEY=your-actual-key-here
   ```
...
- `STATUSPRO_API_KEY` - Your StatusPro API key (required for integration tests)
- `STATUSPRO_BASE_URL` - API base URL (defaults to production)
...
- Make sure `STATUSPRO_API_KEY` is set in `.env`
