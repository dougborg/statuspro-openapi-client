...
We need to generate TypeScript types and SDK functions from the StatusPro OpenAPI
...
- [Python ADR-002: OpenAPI Code Generation](../../../statuspro_public_api_client/docs/adr/0002-openapi-code-generation.md)
