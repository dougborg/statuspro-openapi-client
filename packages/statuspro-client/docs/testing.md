...
This guide explains the testing architecture and approach for the TypeScript StatusPro
client.
...
**`tests/client.test.ts`** - StatusProClient Tests
...
Integration tests require a real API key and hit the actual StatusPro API.
