...
The **StatusProClient** is the TypeScript client for the
[StatusPro API](https://app.orderstatuspro.com/api/v1). It wraps the generated
...
StatusPro is a small API (seven endpoints covering order status lookup and update), so
